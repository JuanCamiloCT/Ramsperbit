<div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                ...
                <a class="btn btn-primary" href="<?= URL ?>Ficha/registrar"><span class="glyphicon glyphicon-plus-sign"></span>Registrar</a>
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($FT as $value): ?>
                    ...
                    <td><?= $value['codFicha'] ?></td>
                    <td><?= $value['nombre'] ?></td>
                    <td><?= $value['nombre_cientifico'] ?></td>
                    <td><?= $value['forma_farmaceutica_cod_forma'] ?></td>
                    <td><?= $value['unidad'] ?></td>
                    ...
                    <td>
                      ...
                      <a href="#" onclick="Vermas(<?= $value['codFicha'] ?>)" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open" ></span></a>
                      <a href="<?= URL ?>Ficha/editar/<?= $value['codFicha'] ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>


                      <!--Estados-->
                      <?php if ($value["estado"] ==1){?>
                        <a href="#" onclick="cambiarEstadoFT(<?= $value['codFicha'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                      <?php }else {?>
                        <a href="#"  onclick="cambiarEstadoFT(<?= $value['codFicha'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                      <?php } ?>
  ...
  <!-- Modal -->
                <div class="modal" id="Ver" tabindex="-1"role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body" id="Modalficha">
                ...
                <!--Ver entradas-->
        <div class="modal fade" id="verft" role="dialog">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <div class="col-md-12">
                  <h4><span <span class="glyphicon glyphicon-list-alt"></span> -Más información de ficha técnica:</h4></label><input type="hidden" name="codFicha" id="codFicha">
                </div>
              </div>
              <div class="modal-body">
               <div class="panel-body">
                 ...
                 <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                ...
                                <br>
                              <table div class="table table-bordered">
                                <thead>
                                   <tr>
                      ...
                      buttons: [
                          {
                            ...
                            pageSize: 'LEGAL',
                            title: 'FICHA TÉCNICA',
                            message: 'Información basica de las fichas tecnicas.',
                            text: 'Descargar',
