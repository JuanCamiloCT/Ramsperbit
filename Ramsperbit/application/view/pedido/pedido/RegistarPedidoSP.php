  ...
  <section class="content">
   ...
   <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="<?= URL ?>pedido/insertarSP" method="POST">
        <div class="box-body">
          <div class="col-md-12">
             <div class="col-md-6">
               <div class="col-md-6">
...
<center>
            <div class="box-header with-border">
              ...
              <a href="<?php echo URL; ?>pedido/indexSP" class="btn btn-warning"><span class="glyphicon glyphicon-remove"></span>Cancelar</button></a>
            </div>
          </center>
...
<script>
      ...
      function quitarPedido(elemento) {
        ...
        html +=  '<p>Codigo de producto: '+cProducto+'</p>';
        html +=  '<p>Codigo Pedido: '+cPedido+'</p>';
