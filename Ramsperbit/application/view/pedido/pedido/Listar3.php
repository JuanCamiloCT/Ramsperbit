        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary"  href="<?= URL ?>pedido/registrarSP" ><span class="glyphicon glyphicon-plus-sign"></span>Registrar</a>
            </div>
        ...
        buttons: [
            {
              ...
              pageSize: 'LEGAL',
              title: 'PEDIDO',
              message: 'Información sobre los pedidos pendientes o finalizados.',
              text: 'Descargar',
