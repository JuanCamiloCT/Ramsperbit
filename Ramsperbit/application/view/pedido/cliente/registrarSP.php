  ...
  <section class="content">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= URL ?>cliente/insertarSP" method="POST" id="registrarCliente">
          <div class="box-body">
          ...
          <div class="box-header with-border">
             <button class="btn btn-info" type="button" name="enviar" id="enviar"><span class="glyphicon glyphicon-ok"></span>Registrar</button>
               <a href="<?php echo URL; ?>cliente/indexSP" class="btn btn-warning" type="button"><span class="glyphicon glyphicon-remove"></span>Cancelar</a>
          </div>
        </div>
        </div>
        </form>
