    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-red">
          ...
          <a href="<?= URL ?>cliente/indexPersona" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="<?= URL ?>cliente/registrar"><span class="glyphicon glyphicon-plus-sign"></span> Registrar</a>
