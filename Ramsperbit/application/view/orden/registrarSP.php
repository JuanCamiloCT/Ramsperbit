  ...
  <section class="content">
    ...
    <div class="col-md-12">
      ...
      <center>
        ...
        <form role="form" action="<?= URL ?>orden/insertarSP" method="POST">
        <div class="box-body">
      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="form-group">
          <label>*Identificación del Empleado:</label>
            <select class="form-control select2" id="id"name="txtid" style="width: 100%;">
            <option value="null">Seleccionar</option>
          ...
          <div class="col-md-6  col-md-offset-5">
                <div class="box-header with-border">
                  <button value="registrar" class="btn btn-info" type="button" name="enviar" id="enviar"><span class="glyphicon glyphicon-ok"></span>Registrar</button>
                   ...
                   <button value="Cancelar" class="btn btn-warning" href="<?= URL ?>orden/indexSP"><span class="glyphicon glyphicon-remove"></span>Cancelar</button>
                </div>
          </div>
        </div>
        </form>
