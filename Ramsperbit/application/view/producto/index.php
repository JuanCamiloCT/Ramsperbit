        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="<?= URL ?>producto/registrar"><span class="glyphicon glyphicon-plus-sign"></span> Registrar </a>
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach ($produc as $value): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= URL ?>producto/editar/<?= $value['codProducto'] ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                      <?php if($value["estado"] == 1){  ?>
                        <a href="#" onclick="modificarEstadoProducto(<?= $value['codProducto'] ?>,0)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh"></i></a>
                      <?php }else { ?>
                        <a href="#" onclick="modificarEstadoProducto(<?= $value['codProducto'] ?>,1)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh"></i></a>
                      <?php } ?>
                      <a class="btn btn-info btn-sm"  onclick="verP(<?= $value['codProducto']?>)">
  ...
  <div class="modal-dialog-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <div class="col-md-4">
          <h4><span class="glyphicon glyphicon-filter" ></span>-Detalles de Productos:</h4></label><input type="hidden" name="codEntrada" id="codEntrada">
        </div>
      </div>
                      ...
                      <table div class="box box-primary">
                        <thead>
                           <tr>
                             ...
                             <th class="column-title">Stock Minimo</th>
                             <th class="column-title">Ubicacion</th>
                             <th class="column-title">Categoria</th>
                             <th class="column-title">Unidad de medida</th>
                             <th class="column-title">Presentacion</th>
...
<script src="<?php echo URL; ?>js/verProducto.js"></script>
        ...
        buttons: [
            {
              ...
              pageSize: 'LEGAL',
              title: 'PRODUCTOS',
              message: 'Información basica de productos registrados.',
              text: 'Descargar',
