  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="<?= URL ?>Entrada/insertar" method="POST" id="registrarentrada">
        <div class="box-body">
              <div class="col-md-12">
                 <div class="col-md-6">
                   <div class="col-md-6">
          ...
          <label>*ID Empleado:</label>
            ...
            <input type="number" class="form-control"  id="ncant"  min="0" required="true"placeholder="Introduzca la cantidad">
            <br>
...
<center>
          <div class="box-header with-border">
               ...
               <a href="<?php echo URL; ?>Entrada/index"class="btn btn-warning"><span class="glyphicon glyphicon-remove"></span>Cancelar</button></a>
          </div>
        </center>
...
function quitarEntrada(elemento) {
  ...
  html +=  '<p>Código de materia prima: '+cMateria_prima+'</p>';
  html +=  '<p>Código Entrada: '+cEntrada+'</p>';
