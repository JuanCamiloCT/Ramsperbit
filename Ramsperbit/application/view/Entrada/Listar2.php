          ...
          <div class="box">
            <div class="box-header">
                <div class="btn-group pull-right">
                    <a class="btn btn-primary" href="<?= URL ?>Entrada/registrarSP"><span class="glyphicon glyphicon-plus-sign"></span>Registrar</a>
              </div>
        ...
        buttons: [
            {
              ...
              pageSize: 'LEGAL',
              title: 'ENTRADAS',
              message: 'Información sobre las entradas asociadas a materia prima.',
              text: 'Descargar',
