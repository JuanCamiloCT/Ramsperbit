      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?= URL ?>gusuario/index3" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="<?= URL ?>gusuario/registrar"><span class="glyphicon glyphicon-plus-sign"></span> Registrar </a>
                
                <ul class="dropdown-menu" role="menu">
                  <li><a href="#">Adobe PDF (.pdf)</a></li>
                </ul>
              </div>
