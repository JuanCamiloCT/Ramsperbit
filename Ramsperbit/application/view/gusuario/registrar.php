    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <form action="<?= URL ?>gusuario/crear" method="POST" id="registrarEmpleado">
            <div class="box-body">
          <div class="col-md-6">
            <label for="exampleInputEmail1">*Tipo de Documento:</label>
              ...
              <div class="form-group">
                  ...
                  <select class="form-control select2" name="txtpco" id="tp" style="width: 100%;">
                      <option value="null">Seleccionar</option>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtiden" onchange="validaride()" id="txtidenti" placeholder="Introduzca el número de identificación del empleado">
              </div>
              <br>
              <div class="form-group">
...
<!-- Form EPS NIVEL PROFESION -->
              <div class="col-md-6 col-md-offset-5">
                <div class="box-header with-border">
                  ...
                  <a href="<?php echo URL; ?>gusuario" class="btn btn-warning" type="button"><span class="glyphicon glyphicon-remove"></span>Cancelar</a>
                </div>
              </div>
            </div>
          </form>
...
<script type="text/javascript">
  ...
  function validaride () {
    ...
    var iden = $("#txtidenti").val();
    $.ajax({
      dataType:'json',
        type:'post',
        url:uri+"gusuario/ide/"+iden
    }).done(function(response) {
      console.log(response);
      if (response.identificacion == iden) {
        document.getElementById("txtidenti").focus();
