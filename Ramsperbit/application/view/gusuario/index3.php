      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?= URL ?>gusuario/index" class="small-box-footer">Más informacion <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              ...
              <p>Empleado Contrato Definido</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
            <a href="<?= URL ?>gusuario/index2" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Empleado Contrato Indefinido</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
            <a href="<?= URL ?>gusuario/index3" class="small-box-footer">Más información <i class="fa fa-arrow-circle-down"></i></a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title">Empleados Contrato Indefinido</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if($value["estado"] == 1){  ?>
                        <a href="#" onclick="modificarEstadoUsuario(<?= $value['idEmpleado'] ?>,0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh"></i></a>
                      <?php }else { ?>
                        <a href="#" onclick="modificarEstadoUsuario(<?= $value['idEmpleado'] ?>,1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh"></i></a>
                      <?php } ?>
