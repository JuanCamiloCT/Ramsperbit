                ...
                <tbody>
                  <?php foreach ($genero as $value): ?>
                    <tr>
                      ...
                      <td><?= $value["nombre"] ?></td>
                      <td><?= $value['estadog']==1?"Activo":"Inactivo" ?></td>
                      <td>
                        <?php if ($value["estadog"] ==1){?>
                          <a href="#" onclick="cambiarEstadoGene(<?= $value['idGenero'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                        <?php }else {?>
                          <a href="#"  onclick="cambiarEstadoGene(<?= $value['idGenero'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                    ...
                    <tbody>
                      <?php foreach ($documento as $value): ?>
                        <tr>
                          ...
                          <td><?= $value['estadod']==1?"Activo":"Inactivo" ?></td>

                          <td>
                            <?php if ($value["estadod"] ==1){?>
                              <a href="#" onclick="cambiarEstadoDocu(<?= $value['idTipo_documento'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                            <?php }else {?>
                              <a href="#"  onclick="cambiarEstadoDocu(<?= $value['idTipo_documento'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                            <?php } ?>
                            </td>
                        </tr>
                      <?php endforeach; ?>
                  ...
                  <tbody>
                    <?php foreach ($pension as $value): ?>
                      <tr>
                        ...
                        <td><?= $value['estadop']==1?"Activo":"Inactivo" ?></td>

                        <td>
                          <?php if ($value["estadop"] ==1){?>
                            <a href="#" onclick="cambiarEstadoPen(<?= $value['idPension'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                          <?php }else {?>
                            <a href="#"  onclick="cambiarEstadoPen(<?= $value['idPension'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                          <?php } ?>
                         </td>
                      </tr>
                    <?php endforeach; ?>
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">EPS</h3>
                    ...
                    <!-- /.box-header -->
          <div class="box-body">
            <a href="#registroE" style="color: #fff" data-toggle="modal"><button value="Nuevo" class="btn btn-success col-md-offset-11"><span class="glyphicon glyphicon-plus" ></span>Nuevo</button></a><br><br>
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>CÓDIGO</th>
              ...
              <?php foreach ($ep as $value): ?>
                <tr>
                  ...
                  <td><?= $value["nombre"] ?></td>
                  <td><?= $value["abreviatura"] ?></td>
                  <td><?= $value['estadoe']==1?"Activo":"Inactivo" ?></td>

                  <td>
                    <?php if ($value["estadoe"] ==1){?>
                      <a href="#" onclick="cambiarEstadoEps(<?= $value['idEPS'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                    <?php }else {?>
                      <a href="#"  onclick="cambiarEstadoEps(<?= $value['idEPS'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                    <?php } ?>
                  </td>
                </tr>
              <?php endforeach; ?>
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Niveles de Estudio</h3>
                      ...
                      <!-- /.box-header -->
        <div class="box-body">
          <a href="#registroNV" style="color: #fff" data-toggle="modal"><button value="Nuevo" class="btn btn-success col-md-offset-11"><span class="glyphicon glyphicon-plus" ></span>Nuevo</button></a><br><br>
          <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>CÓDIGO</th>
                ...
                <tbody>
                  <?php foreach ($nivel as $value): ?>
                    <tr>
                              ...
                              <td><?= $value["descripcion"] ?></td>
                              <td><?= $value['estadon']==1?"Activo":"Inactivo" ?></td>

                              <td>
                                <?php if ($value["estadon"] ==1){?>
                                  <a href="#" onclick="cambiarEstadoNiv(<?= $value['idNivel_estudio'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                                <?php }else {?>
                                  <a href="#"  onclick="cambiarEstadoNiv(<?= $value['idNivel_estudio'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                                <?php } ?>
                              </td>
                          </tr>
                          <?php endforeach; ?>
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      ...
                      <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                          <a href="#registroPro" style="color: #fff" data-toggle="modal"><button value="Nuevo" class="btn btn-success col-md-offset-11"><span class="glyphicon glyphicon-plus" ></span>Nuevo</button></a><br><br>
                          <table id="example1" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                              <th>CÓDIGO</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?= $value["descripcion"] ?></td>
                                <td><?= $value['estadopr']==1?"Activo":"Inactivo" ?></td>

                                <td>
                                  <?php if ($value["estadopr"] ==1){?>
                                    <a href="#" onclick="cambiarEstadoProf(<?= $value['idProfesion'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                                  <?php }else {?>
                                    <a href="#"  onclick="cambiarEstadoProf(<?= $value['idProfesion'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                                  <?php } ?>
                                 </td>
                            </tr>
                            <?php endforeach; ?>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <!-- /.box-header -->
          <div class="box-body">
            <a href="#registroCa" style="color: #fff" data-toggle="modal"><button value="Nuevo" class="btn btn-success col-md-offset-11"><span class="glyphicon glyphicon-plus" ></span>Nueva</button></a><br><br>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>CÓDIGO</th>
                ...
                <tbody>
                  <?php foreach ($caja as $value): ?>
                    <tr>
                      ...
                      <td><?= $value["descripcion"] ?></td>
                      <td><?= $value['estadoc']==1?"Activo":"Inactivo" ?></td>

                      <td>
                        <?php if ($value["estadoc"] ==1){?>
                          <a href="#" onclick="cambiarEstadoCaja(<?= $value['idCaja_compensacion'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                        <?php }else {?>
                          <a href="#"  onclick="cambiarEstadoCaja(<?= $value['idCaja_compensacion'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                        <?php } ?>
                       </td>
                    </tr>
                  <?php endforeach; ?>
