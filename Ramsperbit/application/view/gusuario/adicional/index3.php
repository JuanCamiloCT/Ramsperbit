<div class="content-wrapper">
  ...
  <div class="tab-content">
    ...
    <form  action="<?= URL ?>genero/crearGSP" method="POST" id="modalGe">
    ...
    <form  action="<?= URL ?>tipodocumento/crearTSP" method="post" id="modalTi">
...
<div class="tab-pane" id="pension">
    <div class="row">
      <div class="col-xs-12">
        ...
        <form  action="<?= URL ?>pension/crearPSP" method="post" id="modalPe">
...
<div class="tab-pane" id="eps">
  ...
  <form  action="<?= URL ?>eps/crearESP" method="POST" id="modalEps">
          ...
          <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <form  action="<?= URL ?>nivelEstudio/crearNSP" method="POST" id="modalEs">
...
<div class="tab-pane" id="profesion">
                  ...
                  <form  action="<?= URL ?>profesion/crearProSP" method="POST" id="modalPro">
...
<div class="tab-pane" id="cajacom">
    ...
    <form  action="<?= URL ?>caja/crearCSP" method="POST" id="modalCa">
