        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="<?= URL ?>gusuario/registrarSP"><span class="glyphicon glyphicon-plus-sign"></span> Registrar </a>
              </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><i class="text-muted fa fa-id-card-o"></i> <strong></strong> - Información del Empleado </h4>
                </div>
