      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?= URL ?>gusuario/indexsp" class="small-box-footer">Más informacion <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            ...
            <a href="<?= URL ?>gusuario/index2sp" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?= URL ?>gusuario/index3sp" class="small-box-footer">Más información <i class="fa fa-arrow-circle-down"></i></a>
          </div>
        </div>
        <!-- ./col -->
