...
<div class="content-wrapper">
  ...
  <section class="content-header">
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($value["estado"] ==1){?>
                      <a href="#" onclick="cambiarEstadoCa(<?= $value['codCategoria'] ?>, 0)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                    <?php }else {?>
                      <a href="#"  onclick="cambiarEstadoCa(<?= $value['codCategoria'] ?>, 1)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh" ></i></a>
                    <?php } ?>
                    </td>
                </tr>
                <?php endforeach ?>
    ...
    <form  action="<?= URL ?>categoria/insertar" method="POST" id="modalCategoria">
