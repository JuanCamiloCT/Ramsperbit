...
<head>
  ...
  <?php
    ...
    session_start();
    if ($_SESSION["nombre_usuario"]  != null && $_SESSION["Rol_idrol"] == 3)
    {
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?= URL ?>home/indexEmp" class="logo">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Optionally, you can add icons to the links -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= URL ?>gusuario/indexEmp">Gestión de Empleado</a></li>

          </ul>
        </li>
        <li><a href="<?= URL ?>cliente/indexEmp"><i class="fa fa-address-book"></i> <span>Clientes</span></a></li>
        <li><a href="<?= URL ?>pedido/indexEmp"><i class="glyphicon glyphicon-hourglass"></i> <span>Pedido</span></a></li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= URL ?>MateriaPrima/indexEmp">Materia Prima</a></li>
            <li><a href="<?= URL ?>Entrada/indexEmp">Entradas</a></li>
            <li><a href="<?= URL ?>Salidas/indexEmp">Salidas</a></li>
            <li><a href="<?= URL ?>medida/indexEmp">Unidades de Medida</a></li>
          </ul>
        </li>
        <li><a href="<?= URL ?>Ficha/indexEmp"><i class="glyphicon glyphicon-list-alt"></i> <span>Ficha Técnica</span></a></li>
        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
           <li><a href="<?= URL ?>presentacion/indexEmp">Presentación</a></li>
           <li><a href="<?= URL ?>categoria/indexEmp">Categoría</a></li>
           <li><a href="<?= URL ?>producto/indexEmp">Producto</a></li>
           <li><a href="<?= URL ?>orden/indexEmp">Orden de Producción</a></li>
           <li><a href="<?= URL ?>lote/indexEmp"></i> <span>Lote</span></a></li>
         </ul>
       </li>
...
<div class="modal-body">
  ...
  <li>
    ...
    <ul>
      <li><a href="<?= URL ?>home/indexEmp"><span>Página de inicio</span></a></li>
    </ul>
  </li>
  <li>
    ...
    <ul>
      ...
      <ul>
        <li><a href="<?= URL ?>gusuario/indexEmp">Listar todos los empleados</a></li>
  ...
  <ul>
    <li><a href="<?= URL ?>cliente/indexEmp"></i> <span>Listar todos los clientes</span></a></li>
...
<ul>
<li><a href="<?= URL ?>pedido/indexEmp"></i> <span>Listar todos los pedidos</span></a></li>
  ...
  <li>
    ...
    <ul>
      <li><a href="<?= URL ?>MateriaPrima/indexEmp">Listar todas las materias primas</a></li>
   </ul>
     <span>Entradas:</span>
     <ul>
       <li><a href="<?= URL ?>Entrada/indexEmp">Listar todas las entradas</a></li>
    </ul>
    <span>Salidas:</span>
    <ul>
      <li><a href="<?= URL ?>Salidas/indexEmp">Listar todas las salidas</a></li>
   </ul>
   <span>Unidades de medida:</span>
   <ul>
    <li><a href="<?= URL ?>medida/indexEmp">Listar todas las unidades de medida</a></li>
  </ul>
 </ul>
  </li>
    ...
    <ul>
      <li><a href="<?= URL ?>Ficha/indexEmp"></i> <span>Listar todas las fichas técnicas</span></a></li>
    </ul>
  </li>
   ...
   <li>
    ...
    <ul>
     <span>Presentación:</span>
      <ul>
        <li><a href="<?= URL ?>presentacion/indexEmp">Listar todas las presentaciones</a></li>
      </ul>
      <span>Categorías:</span>
      <ul>
      <li><a href="<?= URL ?>categoria/indexEmp">Listar todas las categorías</a></li>
     </ul>
      <span>Producto:</span>
      <ul>
        <li><a href="<?= URL ?>producto/indexEmp">Listar todos los productos</a></li>
      </ul>
      <span>Orden de producción:</span>
      <ul>
        <li><a href="<?= URL ?>orden/indexEmp">Listar todas las órdenes de Producción</a></li>
      ...
      <span>Lote:</span>
      <ul>
      <li><a href="<?= URL ?>lote/indexEmp"><span>Listar todos los lotes</span></a></li>
     </ul>
  </ul>
  </li>
