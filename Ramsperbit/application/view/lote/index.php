        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="<?= URL ?>lote/registrar"><span class="glyphicon glyphicon-plus-sign"></span> Registrar </a>
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach ($lote as $value): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= URL ?>lote/editar/<?= $value['codLote'] ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                      <?php if($value["estado"] == 1){  ?>
                        <a href="#" onclick="modificarEstadoLo(<?= $value['codLote'] ?>,0)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-refresh"></i></a>
                      <?php }else { ?>
                        <a href="#" onclick="modificarEstadoLo(<?= $value['codLote'] ?>,1)" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-refresh"></i></a>
                      <?php } ?>
                    </td>
                </tr>
                <?php endforeach ?>
        ...
        buttons: [
            {
                ...
                pageSize: 'LEGAL',
                title: 'LOTE',
                message: 'Información sobre los lotes registrados.',
                text: 'Descargar',
                pageMargins: [ 50, 50, 60, 60 ], // try #1 setting margins
                margin: [  50, 50, 60, 60  ], // try #2 setting margins
