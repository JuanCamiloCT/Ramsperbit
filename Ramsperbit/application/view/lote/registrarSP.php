  ...
  <section class="content">
    ...
    <div class="col-md-12">
      ...
      <center>
        ...
        <form role="form" action="<?= URL ?>lote/insertarSP" method="POST" id="registrarLote">
        <div class="box-body">
          ...
          <div class="col-md-6 col-md-offset-5">
                <div class="box-header with-border">
                   ...
                   <a href="<?php echo URL; ?>lote/indexSP" class="btn btn-warning" type="button"><span class="glyphicon glyphicon-remove"></span>Cancelar</a>
                </div>
          </div>
          </div>
        </form>
