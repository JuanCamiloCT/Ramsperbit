        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="<?= URL ?>Salidas/registrarSP"><span class="glyphicon glyphicon-plus-sign"></span>Registrar</a>
            </div>
        ...
        buttons: [
            {
              ...
              pageSize: 'LEGAL',
              title: 'SALIDAS',
              message: 'Información sobre las salidas asociadas a materia prima.',
              text: 'Descargar',
