  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="<?= URL ?>Salidas/insertar" method="POST">
          <div class="box-body">
            <div class="col-md-12">
               <div class="col-md-6">
                 <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <label>*Materia prima:</label>
              ...
              <input type="text" class="form-control"  maxlength=""   min="0" id="ncant" placeholder="Introduzca la cantidad">
              <br>
       ...
       function quitarSalida(elemento) {
         ...
         html +=  '<p>Código Salida: '+cSalida+'</p>';
