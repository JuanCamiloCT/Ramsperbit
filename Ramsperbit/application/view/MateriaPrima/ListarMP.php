        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary"  href="<?= URL ?>MateriaPrima/registrar"><span class="glyphicon glyphicon-plus-sign"></span>Registrar</a>
              ...
              <table id="MP" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($MP as $value): ?>
                    ...
                    <tr>
                    <td><?= $value['codMateria_prima'] ?></td>
                    <td><?= $value['nombre'] ?></td>
                    <td><b>$</b><?= $value['precio'] ?></td>
                    <td><?= $value['descripcion'] ?></td>
                    <td>
                      <?php if ($value["cantidad"] <= $value["stock_min"]){?>
                        <h4><span class="label label-danger"><?=$value['cantidad']?></span></h4>
                      <?php } else{?>
                          <?= $value['cantidad'] ?>
                        <?php } ?>
                    </td>
                    <td><?= $value['presentacion'] ?></td>
                    <td><?= $value['Unidad_medida_codUnidad_medida'] ?></td>
                    <td>
                      <?php if ($value["estado"] =="Cuarentena"){?>
                      <center>  <h4><span class="label label-warning">Cuarentena</span></h4></center>
                      <?php }else if ($value["estado"] =="Aprobado"){?>
                        <center><h4><span class="label label-success">Aprobado</span></h4></center>
                      <?php }
                    else if ($value["estado"] =="Rechazado"){?>
                      <center>  <h4><span class="label label-danger">Rechazado</span></h4></center>
                      <?php } ?>
                    </td>
                    <td>
                    <!--  <a href="#" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-eye-open"></i></a>-->
                      <center><a href="<?= URL ?>MateriaPrima/editar/<?= $value['codMateria_prima'] ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i></a></center>
        ...
        buttons: [
            {
              ...
              pageSize: 'LEGAL',
              title: 'MATERIA PRIMA',
              message: 'Información sobre las materias primas registradas.',
              text: 'Descargar',
